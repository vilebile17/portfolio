...
- **Git Repository** -> [Github](https://github.com/vilebile17/Static-site-generator)

![SSG output](/images/ssg.png)

![This uses](https://skillicons.dev/icons?i=py,html,md)
...
such as [Framer](https://www.framer.com/), [Square Space](https://www.squarespace.com/) etc.

The details on how to use it are listed on the [github](https://github.com/vilebile17/Static-site-generator)
